...
const messages = {
  ...
  "action.maritimeRatiosLabel": { en: "Effective maritime trade ratios", "zh-CN": "当前海上贸易兑换比例" },
  ...
  "commerce.redeemResource": { en: "Redeem {resource}; {count} in bank", "zh-CN": "兑换{resource}；银行剩余 {count}" },
